...
<div class="absolute internal-step" style="background-color:#BFBFBF; width:250px; right: 0px; top:0px;">Input</div>
...
<div class="absolute internal-step" style="background-color:#BFBFBF; width:250px; right: 0px; top:0px;">Output</div>
...
<!-- #| eval: false -->
<!-- #| attr-source: 'data-hl-loc="[[2.9,11.2,8.1]]"' -->
<!-- ggtrace_inspect_args(error = TRUE, -->
<!--   x = ggplot(penguins_sm) + -->
...
```{r stage-implicit}
#| eval: false
#| attr-source: 'data-hl-loc="[[1.45,1,6.2]]"'
```
...
```{r stage-explicit}
#| eval: false
#| attr-source: 'data-hl-loc="[[1.45,1,14.1]]"'
```
...
```{r stage-implicit}
#| eval: false
#| attr-source: 'data-hl-loc="[[4.4,1,13.1]]"'
```
...
```{r stage-explicit}
#| eval: false
#| attr-source: 'data-hl-loc="[[4.4,1,24.7]]"'
```

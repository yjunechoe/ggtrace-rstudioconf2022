...
::: {.aside}
Note: `stage()` and `after_stat()` are "new" in `{ggplot2} v3.3.0` (March 2020)
:::
...
::: {.aside}
In `{ggplot2}` _v3.4.0_, `size` aesthetic for lines are renamed to `linewidth`
:::
...
::: {.aside}
Note: `after_scale()` is "new" in `{ggplot2} v3.3.0` (March 2020)
:::
...
- Github: [https://github.com/yjunechoe/ggtrace](https://github.com/yjunechoe/ggtrace)

- Package website: [https://yjunechoe.github.io/ggtrace](https://yjunechoe.github.io/ggtrace)

- Talk at useR!: [https://github.com/yjunechoe/ggtrace-user2022](https://github.com/yjunechoe/ggtrace-user2022)
